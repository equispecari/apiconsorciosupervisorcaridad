...
const base_repository_1 = require("../shared/infraestructure/base.repository");
const tenant_entity_1 = require("./entities/tenant.entity");
let TenantRepository = class TenantRepository extends base_repository_1.OperationRepository {
    constructor(model) {
        super(model);
        this.model = model;
    }
